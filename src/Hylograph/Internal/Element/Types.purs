-- | DEPRECATED — moved to `Hylograph.Element.Types`.
-- |
-- | This module now re-exports the element vocabulary — `ElementType`, `RenderContext` from its new public home.
...
-- | those imports keep working. New code should import `Hylograph.Element.Types`,
...
import Hylograph.Element.Types as ReExport
