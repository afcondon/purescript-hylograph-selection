...
import Hylograph.Scale.D3 (Scale, Continuous, ContinuousScale, Interpolator)
import Hylograph.Scale.D3 (applyScale, clamp, domain, nice, range, round, tickFormat, ticks) as Scale
