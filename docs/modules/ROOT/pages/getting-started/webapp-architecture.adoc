= Web App Architecture with Hylograph
...
*Hylograph renders declaratively*:: You build an AST from your state, Hylograph renders it. When state changes, you re-render.
...
render state =
  HH.div
    ...
    []  -- Hylograph will render into this div
...
The key to integrating Hylograph with Halogen is the callback bridge:
...
* xref:how-to/halogen-events.adoc[Halogen Events from Hylograph] - Detailed event handling
* xref:how-to/simple-webpage.adoc[Hylograph without Halogen] - Simpler setups
