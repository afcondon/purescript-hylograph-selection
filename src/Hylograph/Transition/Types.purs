...
-- |
-- | This is the public API. The header here used to redirect readers to a
-- | `Hylograph.Transition` module that was never written — which is why
-- | consumers imported the internal path instead. Formerly
-- | `Hylograph.Internal.Transition.Types`, which remains as a deprecated
-- | re-export shim.
module Hylograph.Transition.Types
  ( TransitionConfig
  , Easing(..)
  , transition
  , staggeredTransition
