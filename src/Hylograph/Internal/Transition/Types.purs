...
-- |
-- | This module now re-exports the transition vocabulary from its new public home.
...
-- | those imports keep working. New code should import `Hylograph.Transition.Types`,
...
import Hylograph.Transition.Types as ReExport
