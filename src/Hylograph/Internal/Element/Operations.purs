...
elementTypeToString RadialGradient = "radialGradient"
elementTypeToString Stop = "stop"
elementTypeToString PatternFill = "pattern"
elementTypeToString Title = "title"
...
stringToElementType "radialGradient" = RadialGradient
stringToElementType "stop" = Stop
stringToElementType "pattern" = PatternFill
stringToElementType "title" = Title
