...
-- | live in PSD3.Transition.*. These are general-purpose and could potentially be
-- | extracted to a separate psd3-transitions library in the future, mirroring
...
import PSD3.Internal.Transition.Types (Easing(..)) as HATS
