...
(() => {
  ...
  var showSet = function(dictShow) {
    var show8 = show(showArray(dictShow));
    return {
      show: function(s) {
        return "(fromFoldable " + (show8(toUnfoldable1(s)) + ")");
      }
    };
  };
  var fromMap = $$Set;
  ...
  var mkExitingSelection = function(elements) {
    return function(dataArray) {
      return function(doc) {
        var $323 = length(elements) !== length(dataArray);
        if ($323) {
          return unsafeCrashWith("ExitingSelection invariant violated: " + (show2(length(elements)) + (" elements vs " + (show2(length(dataArray)) + " data items"))));
        }
        ;
  ...
  var mkBoundSelection = function(elements) {
    return function(dataArray) {
      return function(indices) {
        return function(doc) {
          var $324 = length(elements) !== length(dataArray);
          if ($324) {
            return unsafeCrashWith("BoundSelection invariant violated: " + (show2(length(elements)) + (" elements vs " + (show2(length(dataArray)) + " data items"))));
          }
          ;
  ...
  var withChild = function(parent2) {
    return function(child) {
      ...
      ;
      throw new Error("Failed pattern match at PSD3.AST (line 327, column 26 - line 335, column 45): " + [parent2.constructor.name]);
    };
  };
  var withBehaviors = function(tree) {
    return function(newBehaviors) {
      ...
      ;
      throw new Error("Failed pattern match at PSD3.AST (line 369, column 35 - line 377, column 45): " + [tree.constructor.name]);
    };
  };
  ...
  var hierarchicalJoin = function(config) {
    return function(parentData) {
      return function(parentKeyFn) {
        return function(getChildren) {
          return function(childKeyFn) {
            return function(template) {
              return new HierarchicalJoin({
  ...
  var OpaqueSource = /* @__PURE__ */ (function() {
    function OpaqueSource2() {
    }
    ;
    OpaqueSource2.value = new OpaqueSource2();
    return OpaqueSource2;
  })();
              ...
              return function(onAllComplete) {
                ...
                return traverse_2(function(attr) {
                  if (attr instanceof StaticAttr) {
                    var $390 = isNumericAttributeValue(attr.value1);
                    if ($390) {
                    ...
                    return setTimeout_(totalDelay)((function() {
                      var $391 = attr.value0 === "textContent";
                      if ($391) {
                  ...
                  if (attr instanceof DataAttr) {
                    ...
                    var $394 = isNumericAttributeValue(value12);
                    if ($394) {
                    ...
                    var totalDelay = effectiveDelay + config.duration;
                    return setTimeout_(totalDelay)((function() {
                      var $395 = attr.value0 === "textContent";
                      if ($395) {
                  ...
                  if (attr instanceof IndexedAttr) {
                    ...
                    var $399 = isNumericAttributeValue(value12);
                    if ($399) {
                      var targetValue = attributeValueToNumber(value12);
                      var animConfig = {
                        duration: config.duration,
                    ...
                    var totalDelay = effectiveDelay + config.duration;
                    return setTimeout_(totalDelay)((function() {
                      var $400 = attr.value0 === "textContent";
                      if ($400) {
                        return setTextContent_(attributeValueToString(value12))(element);
                      }
                      ;
          ...
          return traverseWithIndex_2(function(index3) {
            return function(v) {
              ...
              return function __do2() {
                ...
                return traverse_2(function(attr) {
                  if (attr instanceof StaticAttr) {
                    var $457 = isNumericAttributeValue(attr.value1);
                    if ($457) {
                      var targetValue = attributeValueToNumber(attr.value1);
                      var animConfig = {
                        duration: config.duration,
                  ...
                  if (attr instanceof DataAttr) {
                    ...
                    var $461 = isNumericAttributeValue(value12);
                    if ($461) {
                      var targetValue = attributeValueToNumber(value12);
                      var animConfig = {
                        duration: config.duration,
                    ...
                    return function __do3() {
                      (function() {
                        var $462 = attr.value0 === "textContent";
                        if ($462) {
                  ...
                  if (attr instanceof IndexedAttr) {
                    ...
                    var $466 = isNumericAttributeValue(value12);
                    if ($466) {
                      var targetValue = attributeValueToNumber(value12);
                      var animConfig = {
                        duration: config.duration,
                    ...
                    return function __do3() {
                      (function() {
                        var $467 = attr.value0 === "textContent";
                        if ($467) {
                          return setTextContent_(attributeValueToString(value12))(v.value0)();
                        }
                        ;
  ...
  var applyAttributes = function(element) {
    return function(datum) {
      return function(index3) {
        return function(attrs) {
          return function __do2() {
            when3(index3 === 0)(log4("[applyAttributes] Element 0, applying " + (show5(length(attrs)) + " attrs")))();
            return traverse_2(function(attr) {
              if (attr instanceof StaticAttr) {
                var $518 = attr.value0 === "textContent";
                if ($518) {
                  return setTextContent_(attributeValueToString(attr.value1))(element);
                }
                ;
              ...
              if (attr instanceof DataAttr) {
                ...
                return function __do3() {
                  ...
                  var $521 = attr.value0 === "textContent";
                  if ($521) {
              ...
              if (attr instanceof AnimatedAttr) {
                ...
                var $530 = attr.value0.name === "textContent";
                if ($530) {
                  return setTextContent_(val)(element);
                }
                ;
              ...
              if (attr instanceof AnimatedCompound) {
                ...
                var $533 = attr.value0.name === "textContent";
                if ($533) {
                  return setTextContent_(val)(element);
                }
                ;
        ...
        return function(tree) {
          return function(doc) {
            return function __do2() {
              ...
              if (tree instanceof Node2) {
                when3(index3 === 0)(log4("[updateElementFromTree] Updating element 0, attrs count: " + show5(length(tree.value0.attrs))))();
    ...
    return function(templateFn) {
      return function(boundSel) {
        var v = (function() {
          ...
          ;
          throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2344, column 66 - line 2345, column 32): " + [boundSel.constructor.name]);
        })();
        return traverseWithIndex2(function(idx) {
          return function(datum) {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2350, column 9 - line 2359, column 25): " + [v1.constructor.name]);
          };
        })(v.data);
      };
    };
    ...
    return function(templateFn) {
      return function(pendingSel) {
        var v = (function() {
          ...
          ;
          throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2287, column 68 - line 2288, column 34): " + [pendingSel.constructor.name]);
        })();
        var $605 = $$null(v.parentElements);
        if ($605) {
          return pure4([]);
        }
        ;
        return traverseWithIndex2(function(idx) {
          return function(datum) {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2300, column 11 - line 2320, column 51): " + [v1.constructor.name]);
          };
        })(v.pendingData);
      };
    };
            ...
            if (v1 instanceof ConditionalRender && v2 instanceof Just) {
              ...
              if (v4 instanceof Nothing) {
                var doc = (function() {
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1616, column 33 - line 1616, column 80): " + [v.constructor.name]);
                })();
                return function __do2() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1606, column 3 - line 1618, column 42): " + [v4.constructor.name]);
            }
            ;
      ...
      return function(v1) {
        ...
        if (v1 instanceof Join) {
          return function __do2() {
            ...
            var doc2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1687, column 12 - line 1688, column 43): " + [v2.value0.update.constructor.name]);
            })();
            ...
            var boundSel = mkBoundSelection(allElements)(append12(allData)(updateData))(new Just(range2(0)(length(allElements) - 1 | 0)))(doc2);
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1711, column 19 - line 1713, column 45): " + [v3.constructor.name]);
            })();
        ...
        if (v1 instanceof NestedJoin) {
          return function __do2() {
            ...
            var v3 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1737, column 52 - line 1738, column 34): " + [v2.value0.enter.constructor.name]);
            })();
            var boundSel = mkBoundSelection(elements)(v3.pendingData)(new Just(range2(0)(length(elements) - 1 | 0)))(v3.document);
            var selectionsMap = insert3(v1.value0.name)(boundSel)(combinedChildMap);
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1751, column 19 - line 1753, column 45): " + [v4.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
        ...
        if (v1 instanceof UpdateJoin) {
          return function __do2() {
            var v2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1763, column 5 - line 1765, column 67): " + [v1.value0.keyFn.constructor.name]);
            })();
            ...
            (function() {
              if (v1.value0.behaviors.exit instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1797, column 7 - line 1805, column 20): " + [v1.value0.behaviors.exit.value0.transition.constructor.name]);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1795, column 3 - line 1809, column 16): " + [v1.value0.behaviors.exit.constructor.name]);
            })();
            var enterElementsAndMaps = (function() {
                ...
                (function() {
                  if (v1.value0.behaviors.enter.value0.transition instanceof Just) {
                    ...
                    var pendingData = (function() {
                      ...
                      ;
                      throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1838, column 41 - line 1839, column 54): " + [v2.value0.enter.constructor.name]);
                    })();
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1833, column 7 - line 1849, column 29): " + [v1.value0.behaviors.enter.value0.transition.constructor.name]);
                })();
                return rendered;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1820, column 27 - line 1854, column 68): " + [v1.value0.behaviors.enter.constructor.name]);
            })();
            var enterElements = map9(fst)(enterElementsAndMaps);
            var enterChildMaps = map9(snd)(enterElementsAndMaps);
            var updateElements = (function() {
              if (v1.value0.behaviors.update instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1863, column 7 - line 1879, column 71): " + [v1.value0.behaviors.update.value0.transition.constructor.name]);
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1860, column 21 - line 1882, column 67): " + [v1.value0.behaviors.update.constructor.name]);
            })();
            var allElements = append12(enterElements)(updateElements);
            var combinedChildMap = foldl2(union2)(empty2)(enterChildMaps);
            var doc2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1896, column 12 - line 1897, column 43): " + [v2.value0.update.constructor.name]);
            })();
            var allData = (function() {
              if (v2.value0.enter instanceof PendingSelection) {
                return v2.value0.enter.value0.pendingData;
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1919, column 19 - line 1921, column 45): " + [v3.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
          ...
          return function __do2() {
            ...
            (function() {
              if (v1.value0.behaviors.exit instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1972, column 7 - line 1980, column 20): " + [v1.value0.behaviors.exit.value0.transition.constructor.name]);
              }
              ;
              if (v1.value0.behaviors.exit instanceof Nothing) {
                remove1(v2.value0.exit)();
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1970, column 3 - line 1983, column 16): " + [v1.value0.behaviors.exit.constructor.name]);
            })();
            var enterElementsAndMaps = (function() {
              if (v1.value0.behaviors.enter instanceof Just) {
                var modifiedTemplate = function(datum) {
                ...
                (function() {
                  if (v1.value0.behaviors.enter.value0.transition instanceof Just) {
                    ...
                    var pendingData = (function() {
                      ...
                      ;
                      throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2016, column 41 - line 2017, column 54): " + [v2.value0.enter.constructor.name]);
                    })();
                    var pairs = zipWith(Tuple.create)(enterElements2)(pendingData);
                    return liftEffect2(traverseWithIndex_2(function(index3) {
                      return function(v4) {
                  ...
                  ;
                  throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2011, column 7 - line 2027, column 29): " + [v1.value0.behaviors.enter.value0.transition.constructor.name]);
                })();
                return rendered;
              }
              ;
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2000, column 27 - line 2030, column 92): " + [v1.value0.behaviors.enter.constructor.name]);
            })();
            var updateElements = (function() {
              if (v1.value0.behaviors.update instanceof Just) {
                if (v1.value0.behaviors.update.value0.transition instanceof Just) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2036, column 7 - line 2049, column 86): " + [v1.value0.behaviors.update.value0.transition.constructor.name]);
              }
              ;
              if (v1.value0.behaviors.update instanceof Nothing) {
                return renderTemplatesForBoundSelection1(v1.value0.template)(v2.value0.update)();
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2033, column 21 - line 2050, column 91): " + [v1.value0.behaviors.update.constructor.name]);
            })();
            var enterElements = map9(fst)(enterElementsAndMaps);
            var allElements = append12(enterElements)(updateElements);
            var enterChildMaps = map9(snd)(enterElementsAndMaps);
            ...
            var doc2 = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2069, column 12 - line 2070, column 43): " + [v2.value0.update.constructor.name]);
            })();
            var boundSel = mkBoundSelection(allElements)(innerData)(new Just(range2(0)(length(allElements) - 1 | 0)))(doc2);
            var selectionsMap = insert3(v1.value0.name)(boundSel)(combinedChildMap);
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2082, column 19 - line 2084, column 45): " + [v5.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
        ...
        if (v1 instanceof ConditionalRender) {
          var doc = (function() {
            ...
            ;
            throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2098, column 29 - line 2098, column 76): " + [v.constructor.name]);
          })();
          return function __do2() {
            var dummyElement = createElementWithNS(Group.value)(doc)();
            return new Tuple(dummyElement, empty2);
        ...
        if (v1 instanceof HierarchicalJoin) {
          return function __do2() {
            var v2 = joinData22(v1.value0.parentData)(v1.value0.parentKey)(v)();
            var v3 = (function() {
              if (v2.value0.enter instanceof PendingSelection) {
                return v2.value0.enter.value0;
              }
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2122, column 68 - line 2123, column 34): " + [v2.value0.enter.constructor.name]);
            })();
            var $789 = $$null(v3.parentElements);
            if ($789) {
            ...
            var parentResults = traverseWithIndex2(function(idx) {
              return function(parentDatum) {
                var parentIdx = mod2(idx)(length(v3.parentElements));
                ...
                if (v4 instanceof Just) {
                  return function __do3() {
                    ...
                    var childSelections = foldl2(union2)(empty2)(map9(function(v5) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2134, column 11 - line 2174, column 100): " + [v4.constructor.name]);
              };
            })(v3.pendingData)();
            ...
            var allChildSelections = foldl2(union2)(empty2)(map9(function(v4) {
              return v4.childSelections;
            })(parentResults));
            var parentBoundSel = mkBoundSelection(wrapperElements)(v3.pendingData)(new Just(range2(0)(length(wrapperElements) - 1 | 0)))(v3.document);
            var childBoundSel = mkBoundSelection(allChildElements)(allChildData)(new Just(range2(0)(length(allChildElements) - 1 | 0)))(v3.document);
            ...
            var firstElement = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2206, column 21 - line 2208, column 47): " + [v4.constructor.name]);
            })();
            return new Tuple(firstElement, selectionsMap);
          };
        }
        ;
        throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 1626, column 1 - line 1631, column 74): " + [v.constructor.name, v1.constructor.name]);
      };
    };
  };
        ...
        return function(wrapperType) {
          return function(pendingSel) {
            var v = (function() {
              ...
              ;
              throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2229, column 68 - line 2230, column 34): " + [pendingSel.constructor.name]);
            })();
            return traverseWithIndex2(function(idx) {
              return function(outerDatum) {
                ...
                ;
                throw new Error("Failed pattern match at PSD3.Internal.Selection.Operations (line 2235, column 9 - line 2267, column 57): " + [v1.constructor.name]);
              };
            })(v.pendingData);
          };
        };
  ...
  var discard3 = /* @__PURE__ */ discard(discardUnit)(/* @__PURE__ */ bindWriterT(semigroupString)(bindIdentity));
  ...
  var when4 = /* @__PURE__ */ when(applicativeWriterT2);
  var for_4 = /* @__PURE__ */ for_(applicativeWriterT2)(foldableArray);
  ...
  var showElemType = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Interpreter.English (line 133, column 1 - line 133, column 38): " + [v.constructor.name]);
  };
  var showAttrValue = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Interpreter.English (line 159, column 1 - line 159, column 42): " + [v.constructor.name]);
  };
  ...
  var describeSource = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at PSD3.Interpreter.English (line 124, column 18 - line 130, column 53): " + [v.constructor.name]);
  };
  var describeAttribute = function(v) {
    ...
    ;
    if (v instanceof AnimatedAttr) {
      return "Animate " + (showAttrName(v.value0.name) + (" over " + (show6(v.value0.config.duration) + "ms")));
    }
    ;
    if (v instanceof AnimatedCompound) {
      return "Animate path " + (showAttrName(v.value0.name) + (" over " + (show6(v.value0.config.duration) + "ms")));
    }
    ;
    throw new Error("Failed pattern match at PSD3.Interpreter.English (line 106, column 1 - line 106, column 61): " + [v.constructor.name]);
  };
  var describeTree = function(tree) {
    return function(level) {
      if (tree instanceof Node2) {
        return discard3((function() {
          if (tree.value0.name instanceof Just) {
            return tell2(indent(level) + ("Create a " + (showElemType(tree.value0.elemType) + (' named "' + (tree.value0.name.value0 + '"')))));
          }
          ;
          if (tree.value0.name instanceof Nothing) {
            return tell2(indent(level) + ("Create a " + showElemType(tree.value0.elemType)));
          }
          ;
          ...
          return discard3(when4(!$$null(tree.value0.attrs))(discard3(tell2(" with attributes:\n"))(function() {
            return for_4(tree.value0.attrs)(function(attr) {
              return tell2(indent(level + 1 | 0) + (describeAttribute(attr) + "\n"));
            });
          })))(function() {
            return when4(!$$null(tree.value0.children))(discard3(tell2(indent(level) + ("Then add " + (show22(length(tree.value0.children)) + " child element(s):\n"))))(function() {
              return for_4(tree.value0.children)(function(child) {
      ...
      ;
      if (tree instanceof Join) {
        return discard3(tell2(indent(level) + ("For each of " + (show22(length(tree.value0.joinData)) + " data items, "))))(function() {
          return discard3(tell2("create a " + (tree.value0.key + (' (join named "' + (tree.value0.name + '")')))))(function() {
            return discard3(tell2(" using data-driven attributes\n"))(function() {
      ...
      ;
      if (tree instanceof NestedJoin) {
        return discard3(tell2(indent(level) + ("For each of " + (show22(length(tree.value0.joinData)) + " nested data items, "))))(function() {
          return discard3(tell2("create a " + (tree.value0.key + (' (nested join named "' + (tree.value0.name + '")')))))(function() {
            return discard3(tell2(" using data-driven attributes\n"))(function() {
      ...
      if (tree instanceof UpdateJoin) {
        return discard3(tell2(indent(level) + ("For each of " + (show22(length(tree.value0.joinData)) + " data items, "))))(function() {
          return discard3(tell2("create/update/remove " + (tree.value0.key + (' (update join named "' + (tree.value0.name + '")')))))(function() {
            return discard3(tell2(" with General Update Pattern:\n"))(function() {
              return discard3(when4(isJust(tree.value0.behaviors.enter))(tell2(indent(level + 1 | 0) + "- Enter: elements appear with initial attributes and transition\n")))(function() {
                return discard3(when4(isJust(tree.value0.behaviors.update))(tell2(indent(level + 1 | 0) + "- Update: elements transition to new state\n")))(function() {
                  return discard3(when4(isJust(tree.value0.behaviors.exit))(tell2(indent(level + 1 | 0) + "- Exit: elements transition out then removed\n")))(function() {
                    return tell2(indent(level + 1 | 0) + "(Template function defined for creating elements from data)\n");
                  });
                });
              });
      ...
      if (tree instanceof UpdateNestedJoin) {
        return discard3(tell2(indent(level) + ("For each of " + (show22(length(tree.value0.joinData)) + " nested data items, "))))(function() {
          return discard3(tell2("decompose and create/update/remove " + (tree.value0.key + (' (update nested join named "' + (tree.value0.name + '")')))))(function() {
            return discard3(tell2(" with General Update Pattern:\n"))(function() {
              return discard3(when4(isJust(tree.value0.behaviors.enter))(tell2(indent(level + 1 | 0) + "- Enter: elements appear with initial attributes and transition\n")))(function() {
                return discard3(when4(isJust(tree.value0.behaviors.update))(tell2(indent(level + 1 | 0) + "- Update: elements transition to new state\n")))(function() {
                  return discard3(when4(isJust(tree.value0.behaviors.exit))(tell2(indent(level + 1 | 0) + "- Exit: elements transition out then removed\n")))(function() {
      ...
      ;
      if (tree instanceof ConditionalRender) {
        return discard3(tell2(indent(level) + ("Conditionally render one of " + (show22(length(tree.value0.cases)) + " different specs "))))(function() {
          return discard3(tell2("based on data predicates (chimeric visualization):\n"))(function() {
            return tell2(indent(level + 1 | 0) + "(Predicates and specs defined as functions)\n");
          });
        });
      }
      ;
      if (tree instanceof LocalCoordSpace) {
        return discard3(tell2(indent(level) + "Create local coordinate space for embedded visualization:\n"))(function() {
          return discard3(tell2(indent(level + 1 | 0) + "(Scale functions defined for width/height)\n"))(function() {
      ...
      ;
      if (tree instanceof HierarchicalJoin) {
        return discard3(tell2(indent(level) + "Create hierarchical structure (two-level parent-child):\n"))(function() {
          return discard3(tell2(indent(level + 1 | 0) + ('- Parent join "' + (tree.value0.parentName + '": '))))(function() {
            return discard3(tell2(show22(length(tree.value0.parentData)) + (" " + (tree.value0.parentKey + " elements\n"))))(function() {
              return discard3(tell2(indent(level + 1 | 0) + ('- Child join "' + (tree.value0.childName + '": '))))(function() {
                return discard3(tell2(tree.value0.childKey + " elements inside each parent\n"))(function() {
                  return discard3(tell2(indent(level + 1 | 0) + "(Parent extracts children via getChildren, template receives both parent and child)\n"))(function() {
                    return tell2(indent(level + 1 | 0) + "Children have separate data binding for coordinated highlighting\n");
                  });
                });
              });
            });
      ...
      ;
      throw new Error("Failed pattern match at PSD3.Interpreter.English (line 31, column 27 - line 103, column 102): " + [tree.constructor.name]);
    };
  };
  ...
  // output/Test.HierarchicalJoinDemo/index.js
  ...
  var renderTree3 = /* @__PURE__ */ renderTree(selectionMD3v2Selection_D)(/* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons2(nameIsSymbol)(ordString))()({
    reflectSymbol: function() {
      return "modules";
    }
  })(/* @__PURE__ */ ordArray(/* @__PURE__ */ ordRecord3(/* @__PURE__ */ ordRecordCons(/* @__PURE__ */ ordRecordCons2({
    reflectSymbol: function() {
      return "size";
    }
  })(ordNumber))()(nameIsSymbol)(ordString)))))()({
    reflectSymbol: function() {
      return "color";
    }
  })(ordString)));
  ...
  var vizTree = /* @__PURE__ */ (function() {
    var moduleTemplate = function(pkg) {
      return function(mod3) {
        var pkgIdx = fromMaybe(0)(findIndex(function(p) {
          return p.name === pkg.name;
        })(sampleData));
        var numMods = length(pkg.modules);
        var modY = (toNumber(pkgIdx) - 1.5) * 120;
        var modIdx = fromMaybe(0)(findIndex(function(m) {
          return m.name === mod3.name;
        })(pkg.modules));
        var modX = (toNumber(modIdx) - toNumber(numMods - 1 | 0) / 2) * 40;
        return withBehaviors(elem2(Circle.value)([attrStatic("cx")(show7(modX)), attrStatic("cy")(show7(modY)), attrStatic("r")(show7(mod3.size / 10)), attrStatic("fill")(pkg.color), attrStatic("fill-opacity")("0.7"), attrStatic("stroke")(pkg.color), attrStatic("stroke-width")("2"), attrStatic("cursor")("pointer")]))([onClickWithDatum(function(v) {
          return log5("Clicked: " + (pkg.name + ("/" + mod3.name)));
        }), onMouseEnter(function(v) {
          return log5("Hover enter: " + (pkg.name + ("/" + mod3.name)));
        }), onMouseLeave(function(v) {
          return log5("Hover leave: " + (pkg.name + ("/" + mod3.name)));
        })]);
      };
    };
    return withChild(named(SVG.value)("svg")([attrStatic("width")("800"), attrStatic("height")("600"), attrStatic("viewBox")("-400 -300 800 600"), attrStatic("style")("background: #0f0f23")]))(hierarchicalJoin({
      parentName: "packages",
      parentKey: "g",
      childName: "modules",
      childKey: "circle"
    })(sampleData)(function(pkg) {
      return pkg.name;
    })(function(pkg) {
      return pkg.modules;
    })(function(mod3) {
  ...
  var main = function __do() {
    log5("=== HierarchicalJoin Test ===")();
    log5("")();
    log5("--- English Description of the AST ---")();
    log5(runEnglish(vizTree))();
    log5("")();
    log5("--- Rendering to #viz ---")();
    var selectionsMap = runD3(bind1(select6("#viz"))(function(container) {
      return renderTree3(container)(vizTree);
    }))();
    log5("Render complete. Named selections: " + show15(size(selectionsMap)))();
    log5("Selection names: " + show23(keys2(selectionsMap)))();
    log5("")();
    log5("--- Done ---")();
