...
-- |   Import separately: `import Hylograph.Interpreter.SemiQuine.TreeToCode`
module Hylograph.Interpreter.SemiQuine
  ( treeToCode
  , module Hylograph.Interpreter.SemiQuine.Types
  ) where
...
import Hylograph.Interpreter.SemiQuine.Types (AttributeBinding, AttributeChoice(..), BuilderNode, BuilderTree(..), NodeId)

-- Re-export types
import Hylograph.Interpreter.SemiQuine.Types (BuilderTree(..), BuilderNode, NodeId, AttributeChoice(..), AttributeBinding, emptyNode, defaultAttributesFor) as Hylograph.Interpreter.SemiQuine.Types
