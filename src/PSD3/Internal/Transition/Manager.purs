...
-- | ```
module PSD3.Internal.Transition.Manager
  ( -- * Manager type
...
import PSD3.Transition.Coordinator (TickResult(..)) as Coordinator
import Data.Map (Map)
...
import PSD3.Internal.Attribute (AnimatedValue(..), AnimationConfig, EasingType(..))
