...
:description: How to run PSD3 force simulations in React with tick callbacks and drag
...
1. **Drag start**: Reheat simulation (alpha → 1.0)
...
* xref:how-to/react-events.adoc[React Events from PSD3] - Click handlers
* xref:how-to/react-integration.adoc[PSD3 in a React App] - Basic integration
* xref:how-to/halogen-events.adoc[Halogen Events from PSD3] - Compare approaches
