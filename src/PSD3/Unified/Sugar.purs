-- | PSD3.Unified.Sugar - Syntactic Sugar for DataDSL
-- |
...
import PSD3.Unified.DataDSL (class DataDSL)
import PSD3.Unified.DataDSL (sin, cos, tan, asin, acos, atan, atan2, pi) as TrigExports
import PSD3.Unified.DataDSL as D
