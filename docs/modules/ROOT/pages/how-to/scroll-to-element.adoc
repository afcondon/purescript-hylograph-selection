...
[source,purescript]
----
import PSD3.Internal.Behavior.FFI (scrollToElement)
...
[source,purescript]
----
import PSD3.Internal.Behavior.FFI (scrollToElementById_)
...
* xref:how-to/halogen-events.adoc[Halogen Events from PSD3] - More interaction patterns
